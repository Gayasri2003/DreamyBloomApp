...
val newArrivals = listOf(
    Product(1, "Lip Balm", "790", R.drawable.product_img_lipbalm, "Skincare"),
    Product(2, "Face Wash", "1650", R.drawable.product_img_facewash, "Skincare"),
    Product(3, "Body Milk", "3200", R.drawable.product_img_bodymilk, "Body Care"),
    Product(4, "Lotion Oil", "2850", R.drawable.product_img_lotionoil, "Body Care"),
    Product(5, "Toner Mist", "1250", R.drawable.product_img_toner, "Skincare"),
    Product(6, "Face Serum", "1380", R.drawable.product_img_facecerum, "Skincare"),
)
...
val mostPurchased = listOf(
    Product(10, "Daily Cream", "1300.00", R.drawable.product_img_dailycream, "Skincare"),
    Product(11, "Face Cream", "1600.00", R.drawable.product_img_facilcream, "Skincare"),
    Product(12, "Oil Serum", "2800.00", R.drawable.product_img_oilserum, "Skincare"),
    Product(13, "Eye Shadow", "1000.00", R.drawable.product_img_eyeshadow, "Makeup"),
    Product(14, "Mascara", "980.00", R.drawable.product_img_mascara, "Makeup"),
    Product(15, "Lipstick", "820.00", R.drawable.product_img_lipstick, "Makeup"),
)
...
val productData = mapOf(
    ...
    "Hair Care Essentials" to listOf(
        Product(301, "Scalp Shampoo", "1,400.00", R.drawable.ic_launcher_foreground, "Hair Care"),
